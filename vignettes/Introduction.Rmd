...
Using reconstructr, we can conveniently divide events into sessions with the <code>reconstruct_sessions</code> function. This takes a list of numeric vectors - each one containing the value, in seconds, of each event associated
