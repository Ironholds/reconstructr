...
Research done by the package authors (and others) in 2014, however, suggests that time-based heuristics may actually not be as inaccurate as previously thought.
